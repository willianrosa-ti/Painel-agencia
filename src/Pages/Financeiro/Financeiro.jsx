...
export default function Financeiro() {
  ...
  // 1. A MÁGICA DA MEMÓRIA: Quando a tela carregar, ele tenta ler o localStorage.
  // Se estiver salvo como 'false' (fechado), ele já começa fechado. Senão, começa aberto.
  ...
  // 2. FUNÇÃO DO BOTÃO: Além de inverter o olho na tela, já salva a preferência no navegador
  ...
  useEffect(() => {
    const buscarDadosFinanceiros = async () => {
      ...
      try {
        const resposta = await fetch(`https://motoapp-bwadauh0dbcqbubb.centralus-01.azurewebsites.net/api/Financeiro/resumo?periodo=${periodo}`, {
          ...
          <div className="grid-financeiro">
            ...
            <div className="cartao-financeiro cartao-destaque-verde">
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.5rem' }}>
                ...
                {/* 3. BOTÃO CHAMA A NOVA FUNÇÃO QUE TEM MEMÓRIA */}
                <button 
              ...
              <p style={{ color: '#666', fontSize: '0.9rem', marginTop: 0 }}>Referência: {periodo}</p>
              
              <div style={{ fontSize: '2.5rem', fontWeight: 'bold', margin: '1rem 0', color: '#1f2937' }}>
                R$ {mostrarValor ? dadosFinanceiros.arrecadacao.toFixed(2) : '-----'}
              </div>
            ...
            <div className="cartao-financeiro cartao-destaque-azul">
              ...
              <p style={{ color: '#666', fontSize: '0.9rem' }}>Referência: {periodo}</p>
